...
import playstore from './assets/undraw_receipt_re_fre3.svg';
        ...
        <>
            ...
            <div className="billing min-h-5/6  grid grid-cols-1 lg:grid-cols-2 items-center">
                <div className="welcome-singh h-full p-[3vw] w-full flex flex-col justify-center items-center text-white bg-[#315ED2]">
                    ...
                    <h1 className="text-5xl pb-2  w-fit border-b-4 mx-auto border-white font-medium text-center my-5 md:my-10 leading-[4rem]">Here you can update your<br />Billing Address</h1>
                </div>
