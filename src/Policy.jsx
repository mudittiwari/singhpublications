            ...
            <div className="policy grid gap-3 sm:gap-5 py-[2vw] px-[10vw] mx-auto">
                ...
                <div className="points">
                    <ul className="list-disc pl-10">
                        <li>Visit our website at <span className="text-[#315ED2]"> https://singhpublication.in/,</span> or any website of ours that links
                            to this privacy notice
                        </li>
                        <li>Download and use our mobile application (Singh Publication), or any other
                ...
                <p><span className="text-xl font-medium">Questions or concerns?</span> Reading this privacy notice will help you understand your
                ...
                <p><span className="text-lg font-bold">This summary provides key points from our privacy notice, but you can find
                    ...
                    looking for</span></p>
                <p><span className="text-lg font-bold">What personal information do we process?</span> When you visit, use, or navigate our
                    Services, we may process personal information depending on how you interact with
                    Singh Publication and the Services, the choices you make, and the products and
                    features you use. Learn more about <span className="text-[#315ED2]"> personal information you disclose to us.</span></p>
                <p><span className="text-lg font-bold">Do we process any sensitive personal information?</span> We do not process sensitive
                    personal information.
                </p>
                <p><span className="text-lg font-bold">Do we receive any information from third parties?</span> We do not receive any
                    information from third parties.
                </p>
                <p><span className="text-lg font-bold">How do we process your information?</span> We process your information to provide,
                    ...
                    legal reason to do so. Learn more about <span className="text-[#315ED2]"> how we process your information.</span>
                </p>
                <p><span className="text-lg font-bold">In what situations and with which parties do we share personal information?</span>
                ...
                <p><span className="text-lg font-bold">How do you exercise your rights?</span>How do we keep your information safe? We have organizational and technical
                    ...
                    about <span className="text-[#315ED2]">how we keep your information safe.</span></p>
                <p><span className="text-lg font-bold">How do you exercise your rights?</span>What are your rights? Depending on where you are located geographically, the
                ...
                <div className="table-content text-[#315ED2]">
                    ...
                    <p>3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL
                        INFORMATION?</p>
                ...
                <p>We collect personal information that you voluntarily provide to us when you register
                    ...
                    you contact us.</p>
                <p><span className="text-lg font-bold">Personal Information Provided by You.</span> The personal information that we collect
                ...
                <p><span className="text-lg font-bold">We process your personal information for a variety of reasons, depending on
                    how you interact with our Services, including:</span>
                </p>
                <div className="points">
                    <ul className="list-disc pl-10">
                        <li><span className="text-lg font-bold">To facilitate account creation and authentication and otherwise manage
                            user accounts.</span> We may process your information so you can create and log
                            in to your account, as well as keep your account in working order.</li>
                        <li><span className="text-lg font-bold">To save or protect an individual's vital interest.</span> We may process your
                ...
                <p><span className="text-lg font-bold underline-offset-4">If you are located in the EU or UK, this section applies to you.</span></p>
                <p>The General Data Protection Regulation (GDPR) and UK GDPR require us to explain
                    ...
                    such, we may rely on the following legal bases to process your personal information:</p>
                <div className="points">
                    <ul className="list-disc pl-10">
                        ...
                        <li><span className="text-lg font-bold">Legal Obligations:</span> We may process your information where we believe it is
                            ...
                            involved.</li>
                        <li><span className="text-lg font-bold">Vital Interests:</span> We may process your information where we believe it is
                ...
                <p><span className="text-lg font-bold underline-offset-4">If you are located in Canada, this section applies to you.</span></p>
                <p>We may process your information if you have given us specific permission (i.e.,
                    ...
                    can <span className="text-[#315ED2]">withdraw your consent</span> at any time.
                </p>
                <p>In some exceptional cases, we may be legally permitted under applicable law to
                ...
                <div className="points">
                    <ul className="list-disc pl-10">
                        <li><span className="text-lg font-bold">Business Transfers:</span> We may share or transfer your information in connection
                        ...
                        <li><span className="text-lg font-bold">Offer Wall:</span> Our application(s) may display a third-party hosted "offer wall."
                ...
                <p>In some regions (like the EEA, UK, and Canada), you have certain rights under
                ...
                <p><span className="text-lg font-bold underline-offset-4">Withdrawing your consent:</span> If we are relying on your consent to process your
                    ...
                    provided in the section "<span className="text-[#315ED2]">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</span>"
                    below.
                </p>
                <p>However, please note that this will not affect the lawfulness of the processing before
                    ...
                    consent.</p>
                <p><span className="text-lg font-bold underline-offset-4">Opting out of marketing and promotional communications:</span> You can unsubscribe
                    from our marketing and promotional communications at any time by or by contacting
                    us using the details provided in the section "HOW CAN YOU CONTACT US ABOUT
                    6/7
                    Singh Publication
                    THIS NOTICE?" below. You will then be removed from the marketing lists. However,
