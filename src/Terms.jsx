    ...
    return (
        <div className="w-full">
            <div className="policy grid gap-3 sm:gap-5 py-[2vw] px-[10vw] mx-auto">
                <h1 className="text-2xl md:text-5xl font-medium text-center text-[#315ED2] mb-3 sm:mb-10">Terms and Conditions</h1>
                <p>Welcome to Singh Publication!</p>
                <p>These terms and conditions outline the rules and regulations for the use of Singh Publication's
                    Website, located at https://singhpublication.in/.
                </p>
                <p>By accessing this website, we assume you accept these terms and conditions. Do not continue
                    to use Singh Publication if you do not agree to take all of the terms and conditions stated on this
                    page.</p>
                <p>The following terminology applies to these Terms and Conditions, Privacy Statement and
                    ...
                    of the Company's stated services, in accordance with and subject to, prevailing law of in. Any
                    use of the above terminology or other words in the singular, plural, capitalization and/or he/she or
                ...
                <p>We employ the use of cookies. By accessing Singh Publication, you agreed to use cookies in
                    agreement with the Singh Publication's Privacy Policy.
                </p>
                ...
                <h2 className="text-lg md:text-2xl font-medium ">License</h2>
                <p>Unless otherwise stated, Singh Publication and/or its licensors own the intellectual property rights
                    for all material on Singh Publication. All intellectual property rights are reserved. You may access
                    this from Singh Publication for your own personal use subjected to restrictions set in these terms
                    and conditions.
                </p>
                <p>You must not:</p>
                <div className="points">
                    <ul className="list-disc pl-10">
                        <li>Republish material from Singh Publication</li>
                        <li>Sell, rent or sub-license material from Singh Publication</li>
                        <li>Reproduce, duplicate or copy material from Singh Publication</li>
                        <li>Redistribute content from Singh Publication</li>
                    </ul>
                </div>
                ...
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                    information in certain areas of the website. Singh Publication does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and
                    opinions of Singh Publication, its agents and/or affiliates. Comments reflect the views and
                    opinions of the person who post their views and opinions. To the extent permitted by applicable
                    laws, Singh Publication shall not be liable for the Comments or for any liability, damages or
                ...
                <p>Singh Publication reserves the right to monitor all Comments and to remove any Comments
                ...
                <p>You hereby grant Singh Publication a non-exclusive license to use, reproduce, edit and authorize
                    others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
                <h2 className="text-lg md:text-2xl font-medium ">Hyperlinking to our Content</h2>
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                    make us look unfavourably to ourselves or to our accredited businesses; (b) the organization
                    does not have any negative records with us; (c) the benefit to us from the visibility of the
                    hyperlink compensates the absence of Singh Publication; and (d) the link is in the context of
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to Singh Publication. Please include your
                ...
                <p>No use of Singh Publication's logo or other artwork will be allowed for linking absent a trademark
                    license agreement.</p>
                <h2 className="text-lg md:text-2xl font-medium ">iFrames</h2>
                ...
                <h2 className="text-lg md:text-2xl font-medium ">Content Liability</h2>
                <p>We shall not be hold responsible for any content that appears on your Website. You agree to
                    ...
                    on any Website that may be interpreted as libellous, obscene or criminal, or which infringes,
                    otherwise violates, or advocates the infringement or other violation of, any third-party rights.
                </p>
                <h2 className="text-lg md:text-2xl font-medium ">Reservation of Rights</h2>
                ...
                <h2 className="text-lg md:text-2xl font-medium ">Removal of links from our website
                </h2>
                ...
                <h2 className="text-lg md:text-2xl font-medium ">Disclaimer
                </h2>
