    ...
    return (
        <div className="w-full">
            <div className="policy grid gap-5 py-[2vw] px-[10vw] mx-auto">
                <h1 className="text-5xl font-medium text-center text-[#315ED2] mb-10">Terms and Conditions</h1>
                ...
                <h1 className="text-2xl font-medium ">Hyperlinking to our Content</h1>
                ...
                <p>No use of Singh Publication's logo or other artwork will be allowed for linking absent a trademark
                    license agreement.</p>
                <h1 className="text-2xl font-medium ">iFrames</h1>
                ...
                <h1 className="text-2xl font-medium ">Content Liability</h1>
                ...
                <h1 className="text-2xl font-medium ">Reservation of Rights</h1>
                ...
                <h1 className="text-2xl font-medium ">Removal of links from our website
                </h1>
                ...
                <h1 className="text-2xl font-medium ">Disclaimer
                </h1>
